...
<link rel="stylesheet" href="/resources/css/subMain/main.css" />
<noscript>
	<link rel="stylesheet" href="/resources/css/subMain/noscript.css" />
</noscript>
</head>
<body class="homepage is-preload">
	<div id="page-wrapper">
		...
		<section class="carousel">
			<div class="reel">
				...
				<article>
					<a href="#" class="image featured"><img src="/resources/img/subMain/pic01.jpg"
						alt="" /></a>
					<header>
						<h3>
				...
				<article>
					<a href="#" class="image featured"><img src="/resources/img/subMain/pic02.jpg"
						alt="" /></a>
					<header>
						<h3>
				...
				<article>
					<a href="#" class="image featured"><img src="/resources/img/subMain/pic03.jpg"
						alt="" /></a>
					<header>
						<h3>
				...
				<article>
					<a href="#" class="image featured"><img src="/resources/img/subMain/pic04.jpg"
						alt="" /></a>
					<header>
						<h3>
				...
				<article>
					<a href="#" class="image featured"><img src="/resources/img/subMain/pic05.jpg"
						alt="" /></a>
					<header>
						<h3>
		...
		<div class="wrapper style2">
			...
			<article id="main" class="container special">
				<a href="#" class="image featured"><img src="/resources/img/subMain/pic06.jpg"
					alt="" /></a>
				<header>
					<h2>
			...
			<section id="features" class="container special">
				...
				<div class="row">
					<article class="col-4 col-12-mobile special">
						<a href="#" class="image featured"><img src="/resources/img/subMain/pic07.jpg"
							alt="" /></a>
						<header>
							<h3>
					...
					<article class="col-4 col-12-mobile special">
						<a href="#" class="image featured"><img src="/resources/img/subMain/pic08.jpg"
							alt="" /></a>
						<header>
							<h3>
								<a href="#">Sed quis rhoncus placerat</a>
					...
					<article class="col-4 col-12-mobile special">
						<a href="#" class="image featured"><img src="/resources/img/subMain/pic09.jpg"
							alt="" /></a>
						<header>
							<h3>
				...
				<div class="row">
					...
					<section class="col-4 col-12-mobile">
						...
						<div class="row gtr-25">
							<div class="col-6">
								<a href="#" class="image fit"><img src="/resources/img/subMain/pic10.jpg"
									alt="" /></a>
							</div>
							<div class="col-6">
								<a href="#" class="image fit"><img src="/resources/img/subMain/pic11.jpg"
									alt="" /></a>
							</div>
							<div class="col-6">
								<a href="#" class="image fit"><img src="/resources/img/subMain/pic12.jpg"
									alt="" /></a>
							</div>
							<div class="col-6">
								<a href="#" class="image fit"><img src="/resources/img/subMain/pic13.jpg"
									alt="" /></a>
							</div>
							<div class="col-6">
								<a href="#" class="image fit"><img src="/resources/img/subMain/pic14.jpg"
									alt="" /></a>
							</div>
							<div class="col-6">
								<a href="#" class="image fit"><img src="/resources/img/subMain/pic15.jpg"
									alt="" /></a>
							</div>
						</div>
					</section>
	...
	<!-- Scripts -->
	<script src="/resources/js/subMain/jquery.min.js"></script>
	<script src="/resources/js/subMain/jquery.dropotron.min.js"></script>
	<script src="/resources/js/subMain/jquery.scrolly.min.js"></script>
	<script src="/resources/js/subMain/jquery.scrollex.min.js"></script>
	<script src="/resources/js/subMain/browser.min.js"></script>
	<script src="/resources/js/subMain/breakpoints.min.js"></script>
	<script src="/resources/js/subMain/util.js"></script>
	<script src="/resources/js/subMain/main.js"></script>
